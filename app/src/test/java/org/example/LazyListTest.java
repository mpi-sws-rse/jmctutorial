...
public class LazyListTest {
    ...
    private void test_50_50_workload_lazy_list(int NUM_THREADS) {
    ...
    public void runRandomLazyTest() {
        test_50_50_workload_lazy_list(6);
    }

    @JmcCheck
    @JmcCheckConfiguration(strategy = "trust", numIterations = 130)
    public void runTrustLazyTest() {
        test_50_50_workload_lazy_list(5);
    }
}
